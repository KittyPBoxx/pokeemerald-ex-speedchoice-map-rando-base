...
const u8 gText_TextSpeed[] = _("SPEED");
...
const u8 gText_TextSpeedSlow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}NOWP");
...
const u8 gText_TextSpeedUltr[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ULTR");
